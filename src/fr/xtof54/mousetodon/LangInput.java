...
public class LangInput {
    ...
    public static void show(Activity main, final NextAction next) {
        ...
        final View dialogview = inflater.inflate(R.layout.langinput, null);


        dialog = new AlertDialog.Builder(main).create();
        dialog.setTitle("Enter accepted lang codes");
        dialog.setView(dialogview);
        dialog.setButton(AlertDialog.BUTTON_POSITIVE,"OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        TextView txt = (TextView)dialogview.findViewById(R.id.langs);
